...
// .wrangler/tmp/bundle-6eeOZw/checked-fetch.js
  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "C:\\Users\\yashv\\OneDrive\\Desktop\\coding\\week13\\medium\\Medium\\backend\\node_modules\\@prisma\\client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "C:\\Users\\yashv\\OneDrive\\Desktop\\coding\\week13\\medium\\Medium\\backend\\prisma\\schema.prisma"
      },
      "relativeEnvPaths": {
        "rootEnvPath": null,
        "schemaEnvPath": "../../../.env"
...
// node_modules/@yashvardhandhondge/medium/dist/zod.js
var require_zod = __commonJS({
  "node_modules/@yashvardhandhondge/medium/dist/zod.js"(exports) {
    "use strict";
    init_checked_fetch();
    init_modules_watch_stub();
    var __importDefault = exports && exports.__importDefault || function(mod) {
...
// .wrangler/tmp/bundle-6eeOZw/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-6eeOZw/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
// src/routes/user.ts
var import_medium = __toESM(require_zod());
...
userRoute.post("/signup", async (c) => {
  ...
  try {
    ...
    const jwt2 = await sign2({ id: newUser.id }, c.env.JWT_KEY);
...
userRoute.post("signin", async (c) => {
  ...
  try {
    ...
    const jwt2 = await sign2({ id: user.id }, c.env.JWT_KEY);
    return c.json({ jwt: jwt2 });
  } catch (e) {
...
postRoute.use("/*", async (c, next) => {
  ...
  try {
    const user = await verify2(token, c.env.JWT_KEY);
    if (user) {
